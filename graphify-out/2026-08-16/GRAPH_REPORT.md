...
## Corpus Check
- 84 files · ~102,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 664 nodes · 1720 edges · 50 communities (49 shown, 1 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84c36c1f`
...
Cohesion: 0.26
Nodes (10): date, Season, _seasons_ending(), FakeBot, _seed_seasons(), test_catalog_excludes_all_pack(), test_fulfill_all_grants_everything(), test_fulfill_season_and_idempotent() (+2 more)
...
Cohesion: 0.25
Nodes (17): active_main_product(), all_seasons(), _bonus(), bonus_by_id(), bonus_by_keyword(), current_season(), _episode(), _matches() (+9 more)
