...
## Corpus Check
- 87 files · ~77,865 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 719 nodes · 1885 edges · 46 communities (45 shown, 1 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2a9b60d`
...
Cohesion: 0.09
Nodes (39): _bonus_text(), _club_text(), _command(), handle_incoming(), main_keyboard(), _none_text(), _results_text(), _search_prompt() (+31 more)

### Community 10 - "Settings"
Cohesion: 0.10
Nodes (31): BaseSettings, publish_ready_posts(), Bot, any_seen(), is_seen(), mark_seen(), Settings, date (+23 more)

### Community 11 - "get_settings"
Cohesion: 0.07
Nodes (77): BaseStorage, deliver(), Any, Message, buy_club(), club_bonuses(), club_trial(), _offer() (+69 more)

### Community 12 - "models.py"
Cohesion: 0.08
Nodes (43): async_sessionmaker, AsyncEngine, AsyncSession, add_bonus(), add_episode(), add_product(), add_season(), counts() (+35 more)

### Community 13 - "producer.py"
Cohesion: 0.10
Nodes (39): _week_stats(), week_stats_text(), choose_ambient(), _is_owner(), list_ambients(), owner_only(), owner_panel(), preview_ambient() (+31 more)
...
Cohesion: 0.07
Nodes (71): Записать контакт в БД + Google Sheets. Один пользователь = одна строка (дедуп…, record(), _already_done(), fulfill(), _fulfill_all(), _fulfill_season(), _fulfill_sub(), _fulfill_workbook() (+63 more)
...
Cohesion: 0.14
Nodes (28): bonus_by_button(), callback_query, CallbackQuery, active_main_product(), all_seasons(), all_seasons_pack(), _bonus(), bonus_by_id() (+20 more)
...
- **Why does `get_settings()` connect `get_settings` to `test_vk.py`, `Settings`, `models.py`, `producer.py`, `PipelineInputs`, `notion.py`, `admin.py`, `session_scope`, `sheets.py`, `yookassa.py`, `catalog.py`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `session_scope()` connect `session_scope` to `test_vk.py`, `Settings`, `get_settings`, `models.py`, `producer.py`, `admin.py`, `catalog.py`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `Settings` connect `Settings` to `test_vk.py`, `get_settings`, `models.py`, `producer.py`, `admin.py`, `session_scope`, `catalog.py`?**
